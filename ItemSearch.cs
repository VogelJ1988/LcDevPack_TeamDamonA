...
namespace LcDevPack_TeamDamonA
{
    public class ItemSearch : Form
    {
        ...
        private readonly string Host = ItemSearch.connection.ReadSettings("Host");
        private readonly string User = ItemSearch.connection.ReadSettings("User");
        private readonly string Password = ItemSearch.connection.ReadSettings("Password");
        private readonly string Database = ItemSearch.connection.ReadSettings("Database");
