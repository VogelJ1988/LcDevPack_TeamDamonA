...
namespace LcDevPack_TeamDamonA
{
    public class RareOptSearch : Form
    {
        ...
        private readonly string Host = RareOptSearch.connection.ReadSettings("Host");
        private readonly string User = RareOptSearch.connection.ReadSettings("User");
        private readonly string Password = RareOptSearch.connection.ReadSettings("Password");
        private readonly string Database = RareOptSearch.connection.ReadSettings("Database");
