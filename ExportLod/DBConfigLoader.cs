...
namespace UTIL
{
    ...
    public class DBConfig
    {
        ...
        private readonly string Host = DBConfig.connection.ReadSettings("Host");
        private readonly string User = DBConfig.connection.ReadSettings("User");
        private readonly string Password = DBConfig.connection.ReadSettings("Password");
        private readonly string Database = DBConfig.connection.ReadSettings("Database");
