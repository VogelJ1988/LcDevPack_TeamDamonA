...
namespace LcDevPack_TeamDamonA.Tools
{
    public class SkillPicker : Form
    {
        ...
        private readonly DatabaseHandle databaseHandle = new DatabaseHandle(); //dethunter12 add
        public string[] menuArray = new string[2] //dethunter12 add
        {
      "a_index",
      "a_name_usa"
        };
        private readonly string Host = SkillEditor.connection.ReadSettings("Host"); //dethunter12 add
        private readonly string User = SkillEditor.connection.ReadSettings("User"); //dethunter12 add
        private readonly string Password = SkillEditor.connection.ReadSettings("Password"); //dethunter12 add
        private readonly string Database = SkillEditor.connection.ReadSettings("Database"); //dethunter12 add
