...
namespace LcDevPack_TeamDamonA.Tools
{
    public class QuestEditor : Form
    {
        ...
        private readonly string Host = QuestEditor.connection.ReadSettings("Host");
        private readonly string User = QuestEditor.connection.ReadSettings("User");
        private readonly string Password = QuestEditor.connection.ReadSettings("Password");
        private readonly string Database = QuestEditor.connection.ReadSettings("Database");
