...
namespace LcDevPack_TeamDamonA.Tools
{
    public class BigPetEditor : Form
    {
        ...
        private readonly string Host = BigPetEditor.connection.ReadSettings("Host");
        private readonly string User = BigPetEditor.connection.ReadSettings("User");
        private readonly string Password = BigPetEditor.connection.ReadSettings("Password");
        private readonly string Database = BigPetEditor.connection.ReadSettings("Database");
...
#pragma warning disable CS0169 // The field 'BigPetEditor.panel1' is never used
        private readonly Panel panel1;
#pragma warning restore CS0169 // The field 'BigPetEditor.panel1' is never used
