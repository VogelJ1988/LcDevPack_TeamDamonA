...
namespace LcDevPack_TeamDamonA.Tools.MemoryWorker.ExChange
{
    public partial class ExChange : Form
    {
        ...
        private readonly string Host = ExChange.connection.ReadSettings("Host");
        private readonly string User = ExChange.connection.ReadSettings("User");
        private readonly string Password = ExChange.connection.ReadSettings("Password");
        private readonly string Database = ExChange.connection.ReadSettings("Database");
