...
namespace LcDevPack_TeamDamonA.Tools.MemoryWorker.LacaBall
{
    public partial class LacaBall : Form
    {
        ...
        private readonly string Host = LacaBall.connection.ReadSettings("Host");
        private readonly string User = LacaBall.connection.ReadSettings("User");
        private readonly string Password = LacaBall.connection.ReadSettings("Password");
        private readonly string Database = LacaBall.connection.ReadSettings("Database");
        private readonly string DB_Database = LacaBall.connection.ReadSettings("DB_Database");
