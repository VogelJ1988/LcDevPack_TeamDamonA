...
namespace LcDevPack_TeamDamonA.Tools.MemoryWorker.PetEditor
{
    public class BigPetEditorr : Form
    {
        ...
        private readonly string Host = AffinityEditor.connection.ReadSettings("Host");
        private readonly string User = AffinityEditor.connection.ReadSettings("User");
        private readonly string Password = AffinityEditor.connection.ReadSettings("Password");
        private readonly string Database = AffinityEditor.connection.ReadSettings("Database");
