...
namespace LcDevPack_TeamDamonA.Tools.MemoryWorker.Item
{
    public partial class ItemAll : Form
    {
        ...
        private readonly string Host = ItemAll.connection.ReadSettings("Host");
        private readonly string User = ItemAll.connection.ReadSettings("User");
        private readonly string Password = ItemAll.connection.ReadSettings("Password");
        private readonly string Database = ItemAll.connection.ReadSettings("Database");
