...
namespace LcDevPack_TeamDamonA.Tools.MemoryWorker.Jawel
{
    public partial class JawelData : Form
    {
        ...
        private readonly string Host = JawelData.connection.ReadSettings("Host");
        private readonly string User = JawelData.connection.ReadSettings("User");
        private readonly string Password = JawelData.connection.ReadSettings("Password");
        private readonly string Database = JawelData.connection.ReadSettings("Database");
