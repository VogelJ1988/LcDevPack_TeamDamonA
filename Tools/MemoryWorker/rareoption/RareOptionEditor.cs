...
namespace LcDevPack_TeamDamonA.Tools.MemoryWorker.rareoption
{
    ...
    {
        private readonly string language = ItemAll.connection.ReadSettings("Language");//dethunter12 language selection
...
#pragma warning restore CS0168 // The variable 'ex' is declared but never used
        ...
        private readonly string Host = RareOptionEditor.connection.ReadSettings("Host");
        private readonly string User = RareOptionEditor.connection.ReadSettings("User");
        private readonly string Password = RareOptionEditor.connection.ReadSettings("Password");
        private readonly string Database = RareOptionEditor.connection.ReadSettings("Database");
        ...
        private static readonly List<t_rareoption> RareOptionList = new List<t_rareoption>();
            ...
            tdrop.Items.AddRange(new object[3] //dethunter12 initialize the combo box values at startup 6/3/2019 
      {
         ...
         "2 - Accessory",
            ...
            s0d.Items.AddRange(new object[114]
     {
         "0 - Strength",
         "1 - Dexterity",
         "2 - Intelligence",
         ...
         "9 - Melee Physical Hit Rate",
         "10 - Ranged Physical Hit Rate",
         "11 - Physical Defense",
         ...
         "24 - MP Steal",
         "25 - HP Steal",
         "26 - Increase in fire attribution",
         "27 - Increase in ice attribution",
         "28 - Increase in storm attribution",
         "29 - Increase in ground attribution",
         "30 - Incarese in all attribution",
         "31 - Decrease in fire attribution",
         "32 - Decrease in ice attribution",
         "33 - Decrease in storm attribution",
         "34 - Decrease in ground attribution",
         "35 - Decrease in all attribution.",
         "36 - Increase power",
         "37 - Increase quickness",
         "38 - Increase wisdom",
         "39 - Improve physical constitution",
         "40 - Increase physical-offense power",
         "41 - Increase magical-offense power",
         "42 - Increase physical-defense power",
         "43 - Increase magical-defense power",
         "44 - Stun Attack",
         "45 - Blood Attack",
         "46 - Move attack",
         "47 - Poison Attack",
         "48 - Slow Attack",
         "49 - Reduced Level Requirement",
         "50 - Reduce Weight",
         "51 - MP Absorption",
         "52 - HP Absorption",
         "53 - Dark Attack",
         "54 - Poison Attack",
         "55 - Increase Critical Chance",
         "56 - HP Regen",
         "57 - MP Regen",
         "58 - Skill Cool Down Reduction",
         "59 - Decrease MP Consumption",
         "60 - Stone Resistance",
         "61 - Stun Resistance",
         ...
         "82 - EXP(%)",
         "83 - SP(%)",
         "84 - The finish time of transformation",
         "85 - Increase HP of Pet & Elemental",
         "86 - Increase attack Pet & Elemental",
         "87 - (Attack) Fire Element Lv.",
         "88 - (Attack) Ice Element Lv.",
         "89 - (Attack) Storm Element Lv.",
         "90 - (Attack) Earth Element Lv.",
         "91 - (Attack) Darkness Element Lv.",
         "92 - (Attack) Light Element Lv.",
         "93 - (Defense) Fire Element Lv.",
         "94 - (Defense) Ice Element Lv.",
         "95 - (Defense) Storm Element Lv.",
         "96 - (Defense) Earth Element Lv.",
         "97 - (Defense) Darkness Element Lv.",
         "98 - (Defense) Light Element Lv.",
         "99 - All Stats (4 types)",
         "100 - Absorb PVP Damage(%)",
         "101 - Decrease Time of Debuff(%)",
         "102 - Increase HP Recovery",
         "103 - Increase MP Recovery",
         "104 - Increase Toughness",
         "105 - Increase strong attack",
         "106 - Increase Vital Power",
         "107 - [Personal] Increases all of stats",
         "108 - [Personal] Increases EXP gain",
         "109 - [Personal] Increases gold gains",
         "110 - [Party] Increases all of stats",
         "111 - [Party] Increases EXP gain",
         "112 - [Party] Increases gold gains",
         "-1 - None",

     });
            s1d.Items.AddRange(new object[114]
          {
         "0 - Strength",
         "1 - Dexterity",
         "2 - Intelligence",
         ...
         "-1 - None",
            ...
            s2d.Items.AddRange(new object[114]
          {
         "0 - Strength",
         "1 - Dexterity",
         "2 - Intelligence",
         ...
         "-1 - None",
            ...
            s3d.Items.AddRange(new object[114]
          {
         "0 - Strength",
         "1 - Dexterity",
         "2 - Intelligence",
         ...
         "-1 - None",
            ...
            s4d.Items.AddRange(new object[114]
          {
         "0 - Strength",
         "1 - Dexterity",
         "2 - Intelligence",
         ...
         "-1 - None",
            ...
            s5d.Items.AddRange(new object[114]
          {
         "0 - Strength",
         "1 - Dexterity",
         "2 - Intelligence",
         ...
         "-1 - None",
            ...
            s6d.Items.AddRange(new object[114]
          {
         "0 - Strength",
         "1 - Dexterity",
         "2 - Intelligence",
         ...
         "-1 - None",
            ...
            s7d.Items.AddRange(new object[114]
          {
         "0 - Strength",
         "1 - Dexterity",
         "2 - Intelligence",
         ...
         "-1 - None",
            ...
            s8d.Items.AddRange(new object[114]
          {
         "0 - Strength",
         "1 - Dexterity",
         "2 - Intelligence",
         ...
         "-1 - None",
            ...
            s9d.Items.AddRange(new object[114]
          {
         "0 - Strength",
         "1 - Dexterity",
         "2 - Intelligence",
