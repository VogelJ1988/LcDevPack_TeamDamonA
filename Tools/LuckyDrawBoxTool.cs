...
namespace LcDevPack_TeamDamonA.Tools
{
    public class LuckyDrawBoxTool : Form
    {
        ...
        private readonly string Host = LuckyDrawBoxTool.connection.ReadSettings("Host");
        private readonly string User = LuckyDrawBoxTool.connection.ReadSettings("User");
        private readonly string Password = LuckyDrawBoxTool.connection.ReadSettings("Password");
        private readonly string Database = LuckyDrawBoxTool.connection.ReadSettings("Database");
