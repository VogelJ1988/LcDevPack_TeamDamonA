...
namespace LcDevPack_TeamDamonA.Tools
{
    public class SkillEditor : Form
    {
        ...
        private readonly string Host = SkillEditor.connection.ReadSettings("Host");
        private readonly string User = SkillEditor.connection.ReadSettings("User");
        private readonly string Password = SkillEditor.connection.ReadSettings("Password");
        private readonly string Database = SkillEditor.connection.ReadSettings("Database");
        private readonly DatabaseHandle databaseHandle = new DatabaseHandle();
        public string rowName = "a_index";
        private readonly string Episode = SkillEditor.connection.ReadSettings("Episode");
