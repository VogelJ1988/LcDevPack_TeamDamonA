...
namespace LcDevPack_TeamDamonA.Tools
{
    public class TitleEditor : Form
    {
        ...
        private readonly string Host = TitleEditor.connection.ReadSettings("Host");
        private readonly string User = TitleEditor.connection.ReadSettings("User");
        private readonly string Password = TitleEditor.connection.ReadSettings("Password");
        private readonly string Database = TitleEditor.connection.ReadSettings("Database");
        private readonly string language = TitleEditor.connection.ReadSettings("Language");//dethunter12 language selection
