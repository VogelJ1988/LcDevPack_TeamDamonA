...
namespace LcDevPack_TeamDamonA.Tools
{
    public class MagicEditor : Form
    {
        ...
        private readonly string Host = MagicEditor.connection.ReadSettings("Host");
        private readonly string User = MagicEditor.connection.ReadSettings("User");
        private readonly string Password = MagicEditor.connection.ReadSettings("Password");
        private readonly string Database = MagicEditor.connection.ReadSettings("Database");
