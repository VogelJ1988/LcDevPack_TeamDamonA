...
namespace LcDevPack_TeamDamonA.Tools
{
    public partial class Settings : Form
    {
        ...
        private readonly string language = Settings.connection.ReadSettings("Language"); //read the language from the config
        ...
        private readonly string ClientPath = Settings.connection.ReadSettings("ClientPath"); //read the clientpath from the config
        private readonly string DBdatabase = Settings.connection.ReadSettings("DB_Database");
        public Settings()
        {
            InitializeComponent();
        }
