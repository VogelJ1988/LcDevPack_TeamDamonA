...
namespace LcDevPack_TeamDamonA.Tools
{
    public partial class Reward : Form
    {
        ...
        private readonly string Host = Reward.connection.ReadSettings("Host");
        private readonly string User = Reward.connection.ReadSettings("User");
        private readonly string Password = Reward.connection.ReadSettings("Password");
        private readonly string Database = Reward.connection.ReadSettings("Database");
        ...
        readonly DataTable table2 = new DataTable();
