...
namespace LcDevPack_TeamDamonA.Tools
{
    public class OptionEditor : Form
    {
        ...
        private readonly string Host = OptionEditor.connection.ReadSettings("Host");
        private readonly string User = OptionEditor.connection.ReadSettings("User");
        private readonly string Password = OptionEditor.connection.ReadSettings("Password");
        private readonly string Database = OptionEditor.connection.ReadSettings("Database");
        private readonly string language = OptionEditor.connection.ReadSettings("Language");//dethunter12 language selection
