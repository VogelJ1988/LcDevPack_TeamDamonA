...
namespace LcDevPack_TeamDamonA.Tools
{
    public class ShopEditor : Form
    {
        ...
        private readonly string Host = ShopEditor.connection.ReadSettings("Host");
        private readonly string User = ShopEditor.connection.ReadSettings("User");
        private readonly string Password = ShopEditor.connection.ReadSettings("Password");
        private readonly string Database = ShopEditor.connection.ReadSettings("Database");
        private readonly string language = MobEditor.connection.ReadSettings("Language");//dethunter12 language selection
