...
namespace LcDevPack_TeamDamonA
{
    public class DatabaseHandle
    {
        ...
        private readonly string Host = DatabaseHandle.connection.ReadSettings("Host");
        private readonly string User = DatabaseHandle.connection.ReadSettings("User");
        private readonly string Password = DatabaseHandle.connection.ReadSettings("Password");
        private readonly string Database = DatabaseHandle.connection.ReadSettings("Database");
        private readonly string language = DatabaseHandle.connection.ReadSettings("Language");
        private string name;
